...
def index():
    if request.method == "POST":
        ...
        return render_template("FactFusion.html", responses=response, shown_claim=0)
...
def get_content(content_id):
    ...
    return render_template("FactFusion.html", responses=response, shown_claim=(int(content_id) - 1))
